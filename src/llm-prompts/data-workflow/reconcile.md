...
2. 🔄 **Auto-Create PR** → `getCreatePRPrompt` with default title
3. 📝 **Generate PR Content** → Include reconciliation results
...
> 🚀 **Auto-creating pull request...**  
> 📋 **PR ready for review and merge**

### Integration Points
- **From**: `getRunDbtPrompt` → `getReconcilePrompt`
- **To**: `getReconcilePrompt` → `getCreatePRPrompt` → `getMergeGuardPrompt`
- **Default PR Title**: "🔄 Refactor / Cleanup – auto-generated by MCP"
